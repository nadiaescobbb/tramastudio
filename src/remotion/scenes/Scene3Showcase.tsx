...
export const Scene3Showcase = () => {
  ...
  return (
    ...
    >
      ...
      {/* Ambient Terracotta Light */}
      <div className="absolute -top-32 left-1/2 -translate-x-1/2 w-[800px] h-[500px] rounded-full bg-[hsl(var(--editorial-accent))]/20 blur-[150px] pointer-events-none" />
      ...
      {frame < 170 && (
        <div
          ...
          className="w-full max-w-5xl bg-[hsl(var(--studio-dark-card))] border border-[hsl(var(--studio-dark-border))] rounded-3xl p-6 shadow-2xl z-10 backdrop-blur-xl relative space-y-4 my-auto"
        >
          {/* Browser Chrome Bar */}
          <div className="flex items-center justify-between pb-3 border-b border-[hsl(var(--studio-dark-border))]">
            ...
            <div className="bg-[#090808] px-6 py-1.5 rounded-full border border-[hsl(var(--studio-dark-border))] text-xs font-mono text-[hsl(var(--studio-dark-muted))] flex items-center gap-2">
              <span className="w-2 h-2 rounded-full bg-emerald-500" />
              famvar.com.ar — Catálogo Digital
            </div>
            <span className="font-mono text-xs text-[hsl(var(--editorial-accent))] font-bold">
              PASO 01
            </span>
          </div>

          {/* Browser Content */}
          <div className="overflow-hidden rounded-2xl border border-[hsl(var(--studio-dark-border))] aspect-[21/9] relative shadow-2xl">
            <Img
            ...
            <div className="absolute bottom-6 left-6 right-6 bg-[#0E0D0C]/85 backdrop-blur-md p-5 rounded-xl border border-[hsl(var(--studio-dark-border))] flex items-center justify-between shadow-2xl">
              <div>
                <span className="font-mono text-[10px] uppercase tracking-widest text-[hsl(var(--editorial-accent))] block mb-1">
                  Catálogo Digital & E-Commerce
                </span>
                <h4 className="font-heading text-2xl font-normal text-[hsl(var(--studio-dark-text))]">
