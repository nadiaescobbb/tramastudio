...
export function MiniBrowserCard({ delay = "400ms" }: IconCardProps) {
  return (
    <span
      className="inline-flex items-center align-middle -mx-2 sm:-mx-4 md:-mx-6 lg:-mx-7 group cursor-pointer select-none -my-4 sm:-my-7 md:-my-10 animate-reading-icon"
...
export function MiniMobileCard({ delay = "1600ms" }: IconCardProps) {
  return (
    <span
      className="inline-flex items-center align-middle mx-0.5 sm:mx-1 group cursor-pointer select-none -my-2 sm:-my-4 md:-my-6 animate-reading-icon"
      style={{ animationDelay: delay }}
    >
