...
export function FloatingWhatsApp() {
  return (
    <a
      href={waLink("Hola, vi HeyTrama y quiero hacer una consulta sobre mi proyecto.")}
      target="_blank"
      rel="noopener noreferrer"
      aria-label="Contactar por WhatsApp"
      className="fixed bottom-6 right-6 z-50 flex items-center justify-center w-14 h-14 bg-[#25D366] text-white rounded-full shadow-2xl hover:bg-[#20ba5a] hover:scale-110 transition-all duration-300 group focus:outline-none focus:ring-4 focus:ring-[#25D366]/40"
    >
      {/* WhatsApp SVG Icon */}
      <svg
